...
const RegisterForm: React.FC = () => {
  ...
  const { formik, isVerifyModal, setVerifyCode, verifyCode, handleVerifyEmail } = useRegisterForm();
    ...
    <Fragment>
      ...
      <div className='max-w-md w-full space-y-8 p-10 bg-white rounded-xl z-10'>
        <div className='text-center'>
          <h2 className='mt-6 text-3xl font-bold text-gray-900'>Welcom to My World!</h2>
